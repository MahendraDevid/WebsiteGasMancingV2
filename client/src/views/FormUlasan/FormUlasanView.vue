...
const submitReview = async () => {
  ...
  const reviewPayload = {
    id_tempat: orderData.value.placeId,
      ...
      <div class="form-card">
        <div class="form-group rating-group">
          ...
          <div class="stars-container">
            <svg v-for="star in 5" :key="star" @click="setRating(star)"
              :class="['star-icon', { 'filled': star <= rating }]" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="form-group">
          ...
          <textarea id="review" v-model="comment" rows="5"
            placeholder="Ceritakan pengalaman memancing Anda di sini..."></textarea>
        </div>

        <button class="button-submit-review" @click="submitReview" :disabled="submitting || loading">
      ...
      <div class="modal-content">
        <div class="success-icon-circle">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="check-icon">
