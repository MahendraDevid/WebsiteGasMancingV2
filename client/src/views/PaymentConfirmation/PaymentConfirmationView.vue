...
<template>
  ...
  <div class="confirmation-page-wrapper">
    <main class="confirmation-content-box">
      ...
      <PaymentBox title="" :totalPrice="totalHarga" :nomorPesanan="dataBooking?.orderNumber || 'Memuat...'" />
  ...
  <FooterPayment variant="checkout" :leftTitle="'Total'" :leftSubtitle="totalHarga" :buttonText="'Cek Status Pesanan'"
    nextRoute="/pesanan" />
</template>
