      ...
      <section class="order-list">
        <div class="order-card" v-for="order in allOrders" :key="order.id">
          ...
          <div class="card-image-section">
            <img :src="order.image" :alt="order.title" loading="lazy" onerror="this.src='https://placehold.co/600x400/CCCCCC/FFFFFF?text=Error'">
          </div>
          ...
          <div class="card-content-section">
            ...
            <div class="card-buttons">
              <div class="buttons-row">
                ...
                <button class="button-cancel red-style" @click="cancelOrder(order.id)">Batalkan</button>
              </div>

              <button
                v-if="order.status === 'Lunas'"
                class="button-review"
                @click="goToUlasan(order.id)"
              >
                Beri Ulasan
              </button>
            </div>
